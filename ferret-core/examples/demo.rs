//! Full-pipeline demo of the ferret indexing + search + change detection system.
//!
//! Usage:
//!   cargo run -p ferret-indexer-core --example demo -- <directory> <query>
//!
//! Examples:
//!   cargo run -p ferret-indexer-core --example demo -- ./ferret-indexer-core/src "Trigram"
//!   cargo run -p ferret-indexer-core --example demo -- . "IndexError"
//!   cargo run -p ferret-indexer-core --example demo -- . "fn main"
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if args.len() < 3 {
        ...
        eprintln!();
        eprintln!("Demos the full ferret pipeline:");
    ...
    let index_dir = index_tmp.path().join(".ferret_index");
