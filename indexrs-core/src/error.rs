//! Central error type for the indexrs indexing system.
//!
//! All fallible operations in indexrs-core return [`IndexError`] via the
//! convenience type alias [`Result<T>`].

use crate::types::SegmentId;

/// Central error type for all indexrs operations.
///
