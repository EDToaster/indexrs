//! Daemon client for dispatching MCP tool requests through the ferret daemon.
//!
...
use ferret_indexer_daemon::ensure_daemon;
use ferret_indexer_daemon::types::{DaemonRequest, DaemonResponse};
use ferret_indexer_daemon::wire::read_response;
...
/// Client that dispatches requests to the ferret daemon via Unix socket.
///
